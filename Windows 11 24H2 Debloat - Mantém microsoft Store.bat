...
:: Remover aplicativos pré-instalados, exceto a Microsoft Store
powershell -Command "Get-AppxPackage -AllUsers | Where-Object { $_.Name -notlike '*Store*' } | Remove-AppxPackage"
powershell -Command "Get-AppxProvisionedPackage -Online | Where-Object { $_.PackageName -notlike '*Store*' } | Remove-AppxProvisionedPackage -Online"
echo "Aplicativos pré-instalados removidos, exceto a Microsoft Store."
